...
JAVA_AGENT="-javaagent:/root/jmx2graphite-1.1.0-javaagent.jar=GRAPHITE_HOSTNAME=$GRAPHITE_SERVER;SERVICE_NAME=$GRAPHITE_PREFIX;SERVICE_HOST=$SERVICE_HOST;INTERVAL_IN_SEC=$INTERVAL_IN_SEC"
